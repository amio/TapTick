...
///
/// Uses the iCloud ubiquity container (`iCloud.com.keymagic.app`) to store a shared
...
public final class CloudSyncService: @unchecked Sendable {
    ...
    private static let containerID = "iCloud.com.keymagic.app"
    private static let fileName = "shortcuts.json"

    private let logger = Logger(subsystem: "com.keymagic.app", category: "CloudSync")
